<template>
    <div>
        <EntreeAdresse v-if="entrepriseExiste" :key=key :entrepriseKey=key :nom="nom"
            :numrue="numrue" :rue="rue" :cp="cp" :telephone="telephone" />
        <div v-else class="boxed">Entreprise introuvable!</div>
    </div>
</template>

<script>
import EntreeAdresse from '../components/EntreeAdresse.vue';
